...
///
/// Exposed only for code generated by `package:dynamo_serializable`.
...
K? $enumDecodeNullable<K extends Enum, V>(
  ...
  if (unknownValue == DynamoKey.nullForUndefinedEnumValue) {
    return null;
  }
  ...
  if (unknownValue is! K) {
    throw ArgumentError.value(
      unknownValue,
      'unknownValue',
      'Must by of type `$K` or `DynamoKey.nullForUndefinedEnumValue`.',
    );
  }
