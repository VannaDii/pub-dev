...
class DynamoKey {
  ...
  /// acquired from the [DynamoSerializable.includeIfNull] annotation on the
  /// enclosing class.
  ///
  ...
  /// use the value of [DynamoKey.nullForUndefinedEnumValue] instead. This is
  /// only valid on a nullable enum field.
