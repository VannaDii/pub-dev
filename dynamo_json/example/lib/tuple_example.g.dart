...
Tuple<T, S> _$TupleFromDynamoJson<T, S>(
  ...
  S Function(Object? json) fromDynamoJsonS,
    ...
    Tuple<T, S>(
      fromDynamoJsonT((json['value1'] as Map<String, dynamic>)['UNKNOWN']),
      fromDynamoJsonS((json['value2'] as Map<String, dynamic>)['UNKNOWN']),
    );
...
Map<String, dynamic> _$TupleToDynamoJson<T, S>(
  ...
  Object? Function(S value) toDynamoJsonS,
    ...
    <String, dynamic>{
      'value1': {'UNKNOWN': toDynamoJsonT(instance.value1)},
      'value2': {'UNKNOWN': toDynamoJsonS(instance.value2)},
    };

ConcreteClass _$ConcreteClassFromDynamoJson(Map<String, dynamic> json) =>
    ConcreteClass(
      Tuple<int, DateTime>.fromDynamoJson(
          (json['tuple1'] as Map<String, dynamic>)['M'] as Map<String, dynamic>,
          (value) => value as int,
          (value) => DateTime.parse(value as String)),
      Tuple<Duration, BigInt>.fromDynamoJson(
          (json['tuple2'] as Map<String, dynamic>)['M'] as Map<String, dynamic>,
...
Map<String, dynamic> _$ConcreteClassToDynamoJson(ConcreteClass instance) =>
    <String, dynamic>{
      'tuple1': {
        'M': instance.tuple1.toDynamoJson(
          (value) => value,
          (value) => value.toIso8601String(),
        )
      },
      'tuple2': {
        'M': instance.tuple2.toDynamoJson(
