...
KitchenSink _$KitchenSinkFromDynamoJson(Map json) => KitchenSink(
      ...
      ..dateTimeList = (json['dateTimeList'] as List<dynamic>)
          .map((e) => DateTime.parse(e as String))
          .toList()
      ..nullableSimpleObjectList = (json['nullableSimpleObjectList']
              as List<dynamic>)
          .map((e) => e == null ? null : SimpleObject.fromDynamoJson(e as Map))
          .toList()
      ..map = json['map'] as Map
      ..stringStringMap =
      ...
      ..simpleObject = SimpleObject.fromDynamoJson(json['simpleObject'] as Map)
      ..strictKeysObject =
          StrictKeysObject.fromDynamoJson(json['strictKeysObject'] as Map)
...
JsonConverterTestClass _$JsonConverterTestClassFromDynamoJson(Map json) =>
    JsonConverterTestClass(
      ...
      (json['bigIntMap'] as Map).map(
        (k, e) => MapEntry(k as String,
            const BigIntStringConverter().fromDynamoJson(e as String)),
      ),
...
JsonConverterGeneric<S, T, U> _$JsonConverterGenericFromDynamoJson<S, T, U>(
    ...
    JsonConverterGeneric<S, T, U>(
      ...
      (json['itemMap'] as Map).map(
        (k, e) => MapEntry(k as String,
            GenericConverter<U>().fromDynamoJson(e as Map<String, dynamic>)),
      ),
    );
