...
Person _$PersonFromDynamoJson(Map json) => Person(
      ...
      ..customOrders = json['customOrders'] == null
          ...
          : MyList<Order>.fromDynamoJson((json['customOrders'] as List<dynamic>)
              .map((e) =>
                  Order.fromDynamoJson(Map<String, dynamic>.from(e as Map)))
              .toList())
...
Order _$OrderFromDynamoJson(Map json) {
  $checkKeys(
    json,
  ...
  return Order.custom(
    ...
    (json['items'] as List<dynamic>?)
        ?.map((e) => Item.fromDynamoJson(Map<String, dynamic>.from(e as Map))),
  )
    ...
    ..altPlatforms = (json['altPlatforms'] as Map?)?.map(
      (k, e) => MapEntry(k as String, Platform.fromDynamoJson(e as String)),
    )
    ..homepage =
...
Item _$ItemFromDynamoJson(Map json) => Item(
      json['price'] as int?,
    )
...
Numbers _$NumbersFromDynamoJson(Map json) => Numbers()
...
MapKeyVariety _$MapKeyVarietyFromDynamoJson(Map json) => MapKeyVariety()
...
UnknownEnumValue _$UnknownEnumValueFromDynamoJson(Map json) =>
    UnknownEnumValue()
...
PrivateConstructor _$PrivateConstructorFromDynamoJson(Map json) =>
