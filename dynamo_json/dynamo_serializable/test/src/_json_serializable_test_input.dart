...
@ShouldThrow('`@DynamoSerializable` can only be used on classes.')
@DynamoSerializable() // ignore: invalid_annotation_target
const theAnswer = 42;
...
@DynamoSerializable(createFactory: false, includeIfNull: false)
...
class NoCtorClass {
  ...
  factory NoCtorClass.fromDynamoJson(Map<String, dynamic> json) =>
...
@DynamoSerializable(constructor: 'bob')
...
@DynamoSerializable(ignoreUnannotated: true)
