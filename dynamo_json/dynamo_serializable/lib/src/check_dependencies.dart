...
const _annotationPkgName = 'dynamo_annotation';
final requiredDynamoAnnotationMinVersion = Version.parse('4.6.0');
...
String? _checkAnnotationConstraint(
    ...
    if (includeDevDependencies) {
      ...
      if (dependency == null) {
        return 'You are missing a required dependency on $_annotationPkgName '
            ...
            '"$requiredDynamoAnnotationMinVersion".';
      }
    } else {
      return 'You are missing a required dependency on $_annotationPkgName in '
          ...
          'least "$requiredDynamoAnnotationMinVersion".';
    }
  }
  ...
  final constraintTooLowMessage =
      ...
      'versions before $requiredDynamoAnnotationMinVersion which is not '
      'allowed.';

  if (constraint is Version &&
      constraint < requiredDynamoAnnotationMinVersion) {
  ...
  if (rangeMin == null || rangeMin < requiredDynamoAnnotationMinVersion) {
    return constraintTooLowMessage;
  }
