...
class DynamoLiteralGenerator extends GeneratorForAnnotation<DynamoLiteral> {
  ...
  Future<String> generateForAnnotatedElement(
    ...
    final thing = dynamoLiteralAsDart(content).toString();
...
String dynamoLiteralAsDart(Object? value) {
  ...
  if (value is List) {
    final listItems = value.map(dynamoLiteralAsDart).join(', ');
    return '[$listItems]';
  }
  ...
  if (value is Map) return dynamoMapAsDart(value);
...
String dynamoMapAsDart(Map value) {
