...
class Issue980ParentClass {
  ...
  Map<String, dynamic> toDynamoJson() => _$Issue980ParentClassToJson(this);
...
class Issue1047ParentClass<T> {
  ...
  factory Issue1047ParentClass.fromDynamoJson(
          Map<String, dynamic> json, T Function(Object? json) fromJsonT) =>
      _$Issue1047ParentClassFromJson<T>(json, fromJsonT);

  final List<Issue1047Class<T>> edges;

  Map<String, dynamic> toDynamoJson(Object? Function(T value) toJsonT) =>
