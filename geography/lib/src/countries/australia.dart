...
import '../base.dart';
import 'australia_states.dart';

/// The country of `Australia`, and its 8 states
const Country australia = Country(
  id: 14,
  name: "Australia",
  longitude: 133.0,
  latitude: -27.0,
  ...
  tld: ".au",
  states: [
    australiaAustralianCapitalTerritoryTerritory,
    australiaNewSouthWalesState,
    australiaNorthernTerritoryTerritory,
    australiaQueenslandState,
    australiaSouthAustraliaState,
    australiaTasmaniaState,
    australiaVictoriaState,
    australiaWesternAustraliaState
  ],
  timezones: [
    Timezone(
      abbreviation: "MIST",
