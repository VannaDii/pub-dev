...
const Region bahrainCapitalGovernorate = Region(
    id: 1992,
    parentId: 18,
...
const Region bahrainCentralGovernorate = Region(
    id: 1996,
    parentId: 18,
    ...
    type: null,
    stateCode: "16",
    cities: [bahrainCentralGovernorateMadinatHamad]);
const Region bahrainMuharraqGovernorate = Region(
    id: 1995,
    parentId: 18,
...
const Region bahrainNorthernGovernorate = Region(
    id: 1994,
    parentId: 18,
    ...
    stateCode: "17",
    cities: []);
const Region bahrainSouthernGovernorate = Region(
    id: 1993,
    parentId: 18,
