...
import '../base.dart';
import 'virginislandsus_states.dart';

/// The country of `Virgin Islands (US)`, and its 3 states
const Country virginIslandsus = Country(
  id: 242,
  ...
  tld: ".vi",
  states: [
    virginIslandsusSaintCroixDistrict,
    virginIslandsusSaintJohnDistrict,
    virginIslandsusSaintThomasDistrict
  ],
  timezones: [
    Timezone(
      abbreviation: "AST",
