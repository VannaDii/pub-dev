/// Access to known geographies in South Georgia and their meta data.
library geography;
...
const Country southGeorgia = Country(id: 205, name: "South Georgia", longitude: -37.0,
          ...
          emoji: "🇬🇸", emojiU: "U+1F1EC U+1F1F8",
          iso2: "GS", iso3: "SGS",
          native: "South Georgia", numericCode: "239",
          phoneCode: "500", region: "Americas",
          subregion: "South America", tld: ".gs",
          states: [],
          timezones: [
            Timezone(abbreviation: "GST", gmtOffset: -7200, gmtOffsetName: "UTC-02:00",
                    tzName: "South Georgia and the South Sandwich Islands Time", zoneName: "Atlantic/South_Georgia")
          ],
          translations: {
            "kr": "사우스조지아",
