...
const Region eritreaAnsebaRegion = Region(
    ...
    type: null,
    stateCode: "AN",
    cities: [eritreaAnsebaRegionKeren]);
...
const Region eritreaMaekelRegion = Region(
    ...
    type: null,
    stateCode: "MA",
    cities: [eritreaMaekelRegionAsmara]);
const Region eritreaNorthernRedSeaRegion = Region(
    ...
    type: null,
    stateCode: "SK",
    cities: [eritreaNorthernRedSeaRegionMassawa]);
const Region eritreaSouthernRedSeaRegion = Region(
    ...
    type: null,
    stateCode: "DK",
    cities: [eritreaSouthernRedSeaRegionAssab, eritreaSouthernRedSeaRegionEdd]);
