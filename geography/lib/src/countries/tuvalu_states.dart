...
const Region tuvaluFunafuti = Region(
    ...
    stateCode: "FUN",
    cities: [
      tuvaluFunafutiAlapiVillage,
      tuvaluFunafutiFakaifouVillage,
      tuvaluFunafutiFunafuti
    ]);
const Region tuvaluNanumanga = Region(
    ...
    type: null,
    stateCode: "NMG",
    cities: [tuvaluNanumangaTogaVillage]);
...
const Region tuvaluNiutaoIslandCouncil = Region(
    ...
    stateCode: "NIT",
    cities: [
      tuvaluNiutaoIslandCouncilKuliaVillage,
      tuvaluNiutaoIslandCouncilNiulakita
    ]);
const Region tuvaluNui = Region(
    ...
    type: null,
    stateCode: "NUI",
    cities: [tuvaluNuiTanrakeVillage]);
const Region tuvaluNukufetau = Region(
    ...
    type: null,
    stateCode: "NKF",
    cities: [tuvaluNukufetauSavaveVillage]);
...
const Region tuvaluVaitupu = Region(
    ...
    type: null,
    stateCode: "VAI",
    cities: [tuvaluVaitupuAsauVillage]);

const tuvaluStates = <int, Region>{
  3951: tuvaluFunafuti,
