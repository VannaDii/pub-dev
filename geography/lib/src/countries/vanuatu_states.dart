...
const Region vanuatuMalampa = Region(
    ...
    type: null,
    stateCode: "MAP",
    cities: [vanuatuMalampaLakatoro, vanuatuMalampaNorsup]);
...
const Region vanuatuSanma = Region(
    ...
    type: null,
    stateCode: "SAM",
    cities: [vanuatuSanmaLuganville, vanuatuSanmaPortHypOlry]);
const Region vanuatuShefa = Region(
    ...
    type: null,
    stateCode: "SEE",
    cities: [vanuatuShefaPortHypVila]);
