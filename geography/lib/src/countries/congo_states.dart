...
const Region congoBouenzaDepartment = Region(
    ...
    type: null,
    stateCode: "11",
    cities: [congoBouenzaDepartmentKayes, congoBouenzaDepartmentMadingou]);
const Region congoBrazzaville = Region(
    ...
    type: null,
    stateCode: "BZV",
    cities: [congoBrazzavilleBrazzaville]);
const Region congoCuvetteDepartment = Region(
    ...
    type: null,
    stateCode: "8",
    cities: [congoCuvetteDepartmentMakoua, congoCuvetteDepartmentOwando]);
const Region congoCuvetteHypOuestDepartment = Region(
    ...
    type: null,
    stateCode: "15",
    cities: [congoCuvetteHypOuestDepartmentEwo]);
...
const Region congoLekoumouDepartment = Region(
    ...
    type: null,
    stateCode: "2",
    cities: [congoLekoumouDepartmentSibiti]);
const Region congoLikoualaDepartment = Region(
    ...
    type: null,
    stateCode: "7",
    cities: [congoLikoualaDepartmentImpfondo]);
const Region congoNiariDepartment = Region(
    ...
    type: null,
    stateCode: "9",
    cities: [congoNiariDepartmentDolisie, congoNiariDepartmentMossendjo]);
const Region congoPlateauxDepartment = Region(
    ...
    type: null,
    stateCode: "14",
    cities: [congoPlateauxDepartmentDjambala, congoPlateauxDepartmentGamboma]);
const Region congoPointeHypNoire = Region(
    ...
    type: null,
    stateCode: "16",
    cities: [congoPointeHypNoireLoandjili, congoPointeHypNoirePointeHypNoire]);
const Region congoPoolDepartment = Region(
    ...
    type: null,
    stateCode: "12",
    cities: [congoPoolDepartmentKinkala]);
const Region congoSanghaDepartment = Region(
    ...
    type: null,
    stateCode: "13",
    cities: [congoSanghaDepartmentOuesso, congoSanghaDepartmentSembe]);

const congoStates = <int, Region>{
